...
class CountsRegion extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> countsMode =
        Provider.of<PlayerModel>(context, listen: false).countsRegion;
    ...
    List<HorizontalModel> data = countsModeList.map((item) {
      return HorizontalModel(
          regionConst[item.mode], item.value['games'], item.value['win']);
    }).toList();
